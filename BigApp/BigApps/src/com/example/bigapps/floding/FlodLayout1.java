 ...
 */
public class FlodLayout1 extends ViewGroup
{
	...
	public FlodLayout1(Context context)
	{
		this(context, null);
	}

	public FlodLayout1(Context context, AttributeSet attrs)
	{
		super(context, attrs);
	...
	protected void dispatchDraw(Canvas canvas)
	{
		...
		if (mFactor == 1)
		{
			Log.i(TAG, "dispatchDraw mFactor == 1 ");
