...
/**
 * @author YC
 * @time 2016-3-14 上午11:36:20
 */
public class Client2Activity extends Activity implements OnClickListener {

	private static final String tag = "Client2Activity";
	private static final String START_WITH = "USER_TWO";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.socket_client2);
	...
	private void initViews() {
		mEtSendContent = (EditText) findViewById(R.id.et_client2);
		mBtnSend = (Button) findViewById(R.id.btn_client2_send);
		mBtnSend.setOnClickListener(this);
		mTvContent  = (TextView) findViewById(R.id.tv_client2_content);
		mScrollContent = (ScrollView) findViewById(R.id.scroll2_content);
	}
