...
#include <jni.h>
/* Header for class com_example_resources_ImgUtils_ImageBlur */

#ifndef _Included_com_example_resources_ImgUtils_ImageBlur
#define _Included_com_example_resources_ImgUtils_ImageBlur
#ifdef __cplusplus
extern "C" {
#endif
/*
